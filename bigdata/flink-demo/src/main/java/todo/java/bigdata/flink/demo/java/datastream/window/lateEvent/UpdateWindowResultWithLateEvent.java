package todo.java.bigdata.flink.demo.java.datastream.window.lateEvent;
        ...
        stream
                ...
                .assignTimestampsAndWatermarks(
                        WatermarkStrategy.<Tuple2<String, Long>>forBoundedOutOfOrderness(Duration.ofSeconds(5))
                                .withTimestampAssigner((SerializableTimestampAssigner<Tuple2<String, Long>>) (stringLongTuple2, l) -> stringLongTuple2.f1)
                )
                .keyBy(r -> r.f0)

...
* The original package name 'todo.java.geekbang.design-pattern' is invalid and this project uses 'todo.java.geekbang.designpattern' instead.
...
```
$ docker run --rm -p 8080:8080 design-pattern:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/design-pattern
```
